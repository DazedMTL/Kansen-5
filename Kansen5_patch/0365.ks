...
;//m:b’è‚ÅƒuƒƒbƒN0360‚ÉƒAƒXƒyƒNƒgƒXƒCƒbƒ`‚ğd‚ñ‚¾

;//bgm02.ogg
[bgm storage="BGM02"]

;//bg05a ƒr[ƒ`i•ƒ‰ƒCƒuƒtƒFƒX‰ïêŠOŠÏjE’©’‹
...
[ChrSetEx layer=5 chbase="ha2_sw1_b"][ChrSetParts layer=5 chface="F2_ha13"][ChrSetXY layer=5 x=0 y=0][trans_c cross time=150]
...
;//‰Ä“sƒ‹[ƒg‚ÌD2_b ‰Ô‘òZAP‚Ös‚­ˆ×‚Ìƒtƒ‰ƒO¬—§
[eval exp="f.l_look_0365_araiZAP = 1"]

;//ƒUƒbƒv–ß‚èŒø‰Ê
[zapfade]

;//Ÿ‚ÌƒuƒƒbƒN_‚ÖjumpBb’è‚ÅƒuƒƒbƒN0370‚Ö
