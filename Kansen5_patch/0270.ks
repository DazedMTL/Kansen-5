...
;//ƒV[ƒ“–¼	Fw—[•é‚ê‹ó‚Æ•‚¢“µx
;//file–¼	F0270
;//“oêl•¨	FålŒöA@ˆê˜YAƒ^[ƒ„A—åAˆ©—œ
;//•‘•		F§•
;//“ú•t		F‚WŒ‚P‚S“ú 
;//ŠÔ		F‚P‚W
;//”wŒi		F{İ‚ÌH“°iƒA[ƒJƒCƒu‚É‚ ‚éHHj
;//—\‘z—e—Ê	F‘S‘Ì‚ğ’Ê‚µ‚Ä6~9K‘OŒã
;//”õl		FålŒöˆêlÌ‹“_
;//QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
*0270_TOP
;{SceneSet —[•é‚ê‹ó‚Æ•‚¢“µ}
...
;//šbg19b ‘å_ƒXƒ|[ƒcƒZƒ“ƒ^[E—[•û
[bg storage="BG20b"][trans_c lr time=300]

;mm ‚¢‚ç‚È‚¢‚©[quake_bg xy m]
...
;//m:ƒŒƒIƒ^‚È‚Ì‚©ƒWƒƒ[ƒW‚È‚Ì‚©H—åAƒ^[ƒ„‚ªƒŒƒIƒ^‚É‚µ‚Ä‚¨‚­
...
;//Ÿ‘g‚İ‚İ‚ÉTaryan‚É•ÏŠ·BˆÈ‰ºA–¼‘O‚ª”»–¾‚·‚é‚Ü‚Åƒl[ƒ€ƒ`ƒbƒv‚±‚Ì‚Ü‚Ü
...
;//Ÿ‘g‚İ‚İ‚ÉSatto™‚É•ÏŠ·BˆÈ‰ºA–¼‘O‚ª”»–¾‚·‚é‚Ü‚Åƒl[ƒ€ƒ`ƒbƒv‚±‚Ì‚Ü‚Ü
...
;//m:ÎŠç‚Å\‚µ–ó‚È‚³‚»‚¤‚ÈŠç‚Í–³‚©‚Á‚½‚Ì‚ÅC³

;//‘ºã‚³‚ñ‚ªÎŠç‚Å\‚µ–ó‚È‚³‚»‚¤‚ÈŠç‚ğ‚µ‚Ä‚¢‚éB
...
;//m:‚ ‚Æ‚Åˆ©—œ‚ÉŠÖŒW‚ğà–¾‚·‚éƒV[ƒ“‚ ‚Á‚½‚©‚ÈH
;//u•t‚«‡‚¢‚ª’·‚¢v‚Á‚Ä·‚èã‚ª‚Á‚½‚Î‚©‚è‚Åu’m‚è‡‚¢v‚Í‚¿‚å‚Á‚Æ—â‚½‚¢‹C‚ª‚·‚é‚Ì‚Å
;//‘¼ƒuƒƒbƒNŠm”FŒãA•K—v‚ ‚ê‚ÎuƒQ[ƒ€’‡ŠÔ‚Ìv‚Æ‚©‚ÉC³

[ChrSetEx layer=3 chbase="sa1_le"][ChrSetParts layer=3 chface="F1_sa03"][ChrSetXY layer=3 x=130 y=0]
[ChrSetEx layer=5 chbase="ak1_ja2"][ChrSetParts layer=5 chface="F1_aj18"][ChrSetXY layer=5 x=300 y=0]
[ChrSetEx layer=4 chbase="so1_se_a"][ChrSetParts layer=4 chface="F1_so02a"][ChrSetXY layer=4 x=640 y=0][trans_c cross time=150]
...
[vo_aka s="akari0102"]
[ns]Akari[nse]
u‚ ‚ÌA‚æ‚ë‚µ‚­‚¨Šè‚¢‚µ‚Ü‚·ccA[r][ChrSetEx layer=5 chbase="ak1_ja2"][ChrSetParts layer=5 chface="F1_aj21"][ChrSetXY layer=5 x=300 y=0][trans_c cross time=150]
...
;//ƒuƒƒbƒN0280‚Öjump
[jump storage="0280.ks" target=*0280_TOP]
