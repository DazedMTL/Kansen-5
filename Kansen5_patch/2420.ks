...
;//QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
*2420_TOP
;{SceneSet –a‚ª‚ê‚él‚Ì—ğj}

;//m:ƒvƒƒbƒg‚ÌƒuƒƒbƒN–¼‚s
...
[ChrSetEx layer=5 chbase="ak2_cos"][ChrSetParts layer=5 chface="F2_ak14"][ChrSetXY layer=5 x=0 y=0][trans_c cross time=150]
...
;mm –h‰u‘àˆõ‚ÆƒTƒCƒY‡‚í‚È‚¢‚©‚ç—ƒLƒƒƒ‰‚Æˆê‚É‚Í•\¦‚µ‚È‚¢
[chara_int]
;[ChrSetEx layer=3 chbase="mob_sdf1_x"][ChrSetXY layer=3 x=-90 y=0]
...
[ChrSetEx layer=5 chbase="sa1_kan_le"][ChrSetParts layer=5 chface="F1_sa15"][ChrSetXY layer=5 x=480 y=0][trans_c cross time=150]
[ChrSetEx layer=6 chbase="ta1_le"][ChrSetParts layer=6 chface="F1_ta24"][ChrSetXY layer=6 x=730 y=0][trans_c cross time=150]
[ChrSetEx layer=7 chbase="ha1_kan1"][ChrSetXY layer=7 x=-100 y=0][trans_c cross time=150]
...
[ChrSetEx layer=5 chbase="st1_se1_a"][ChrSetParts layer=5 chface="f1_st14"][ChrSetXY layer=5 x=300 y=0][trans_c cross time=150]
...
;//ÊŒ‘å—‚sƒVƒƒƒcƒJƒƒ‰–³‚µƒ|[ƒY‚`@•\î07”ß‚µ‚İ@@@;//
...
*end01
;//ƒUƒbƒsƒ“ƒOŠJ•ú’m@2005 2005 2005 2340ŠJ•ú
[if exp="sf.g_end_satuki==1"][jump target=*end02][endif]
[movie storage="zap_open.mpg"]
*end02
;//•Ï” "g_1120" ‚ª¬—§‚Í ‰ÁZ‚µ‚È‚¢B
[if exp="sf.g_end_satukiB==1"][jump target=*NO_KASAN][endif]
;//ƒNƒŠƒA‰ñ”‰ÁZ
...
;mm ‹tˆÚA [image storage="com_d" layer=0 page=fore visible=false left=0 top=0]
