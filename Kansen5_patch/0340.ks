...
;//ƒV[ƒ“–¼	Fw‹«ŠEü‚Ì–éx
;//file–¼	F0340
;//“oêl•¨	FålŒöA@ˆê˜YAˆ©—œAÊŒA‰Ä
;//•‘•		F§•
;//“ú•t		F8/17
;//ŠÔ		F21
;//”wŒi		Fƒzƒeƒ‹ƒƒr[(–é)
...
;//
;//deepkiss¬—§‚É‚ÍA‘OƒuƒƒbƒN‚ÅŠ´õƒ‹[ƒg‚É—‚¿‚Ä‚¢‚é‚Ì‚ÅA‚±‚±‚Å‚ÍğŒ‚Ég—p‚µ‚È‚¢B
;//‰Ä“s‚ğG‚í‚Á‚½ê‡A‰Ä“sƒ‹[ƒg‚É—‚¿‚é
;//ƒtƒ‰ƒOtouch_natu¬—§¨—_ƒ‰ƒxƒ‹00342‚Öjump
;//‚»‚êˆÈŠO‚Íƒ‰ƒxƒ‹00342‚Ö
...
;//Ÿ‚È‚ñ‚©–ŒÌ‚ÌƒCƒ[ƒW‰æ‚Ìƒtƒ‰ƒbƒVƒ…ƒoƒbƒN‚Æ‚©
;//#_Ôƒtƒ‰
[evcgÔƒtƒ‰ storage="mob_N014a_L" layer=0 x=-2150 y=-400 z=180 time=300]
...
;//Yƒtƒ‰ƒO0342@¬—§
;//m:‚È‚ñ‚ÌˆÓ–¡‚ğ‚½‚¹‚é‚Ì‚©•s–¾‚È‚Ì‚Å‚Æ‚è‚ ‚¦‚¸ƒtƒ‰ƒO–¼‚±‚Ì‚Ü‚Ü
;//ƒtƒ‰ƒOinfection02‚Å‘ã—p‚Å‚¢‚¢‚Ì‚Å‚ÍH
