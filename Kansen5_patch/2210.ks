...
;//•‘•		F
;//‚ß‚àF”ü¹•‘•‚É‚Â‚¢‚Äc2200.txt‚É‘±‚«„•{”’ˆß‚É“ˆê
;//@@Fˆ©—œ‚Í’¼‘O‚Ü‚Å“¹ê‚Å“ã“‚Ó‚è‚Ü‚í‚µ‚Ä‚¢‚½‚Ì‚Å”¼‘³ƒWƒƒ[ƒW
;//@@@ŠÔˆá‚Á‚Ä‚¢‚½‚çˆêŠ‡’uŠ·‚Å‘Îˆ

;//“ú•t		F8/19 ’©
;//ŠÔ		F
;//êŠ		F‰z’q–{‰Æ
;//—\‘z—e—Ê	F‘S‘Ì‚ğ’Ê‚µ‚Ä6K‘OŒã
;//”õl		F”ü¹‹“_or‘æOÒ‹“_
;//QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
*2210_TOP
;{SceneSet •–‹‚Ì³‘Ì}
...
;//ƒUƒbƒsƒ“ƒO’m@aspect_***@©**‚ğ‚»‚ê‚¼‚ê‚ÌƒLƒƒƒ‰–¼‚É•Ï‚¦‚é
;EDƒ€[ƒr[‚ğ“K‹XÄ¶‚³‚¹‚é
[zapfade storage="aspect_other.mpg"]

[bgm storage="BGM15"]
;//ôbgm15@ƒVƒŠƒAƒXFŒ™‹^Fvl
;•s—vH[wait_c time=1000]

;//m:ƒvƒƒbƒg‚ÌƒuƒƒbƒN–¼G_b
...
;//‚ß‚àF“r’†‚Ü‚Å—§‚¿ŠG‚ğ“\‚Á‚½‚ªA”ü¹‹“_‚È‚Ì‚Åíœ‚Í‚¹‚¸‚ÉƒRƒƒ“ƒgƒAƒEƒg
...
;//š_“y‘ ‘O
;//šbg13a ‰z’q–{‰Æ ŠOŠÏ•‘O’ëE’©’‹
[bg storage="BG13a"][trans_c cross time=500]

;//Ÿ“y‘ ‚ÌŠOŠÏ‚Í•’Ê‚ÆŒ¾‚¤‚±‚Æ‚Å
...
;//šbg16a ‰z’q–{‰Æ@ƒ†ƒjƒbƒgƒ‰ƒ{“à•”E“_“”
...
;//‚ß‚àFê–ÊØ‚è‘Ö‚¦‚ª‚È‚¢‚Ì‚ÅABGM‚àˆÃ“]ˆ—‚à‚È‚µB
;//#_ƒuƒ‰ƒbƒNƒAƒEƒg
