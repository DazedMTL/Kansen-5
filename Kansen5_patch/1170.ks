...
;//ÉVÅ[Éìñº	ÅFÅwÅx
;//fileñº	ÅF1170
;//ìoèÍêlï®	ÅFéÂêlåˆÅAè@àÍòYÅAà©óúÅAâƒìsÅAçrà‰ÅAî¸çπèè
;//ïûëï		ÅFêßïû
;//ì˙ït		ÅF8/19
;//éûä‘		ÅF()
;//îwåi		ÅF()
;//ó\ëzóeó 	ÅFëSëÃÇí ÇµÇƒ20KëOå„
;//îıçl		ÅFéÂêlåˆàÍêlèÃéãì_
;//ÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQÅQ
*1170_TOP
;{SceneSet ìûíÖ}
...
;<SoundVolume 0,-1000,1000>;mm BGMâπó ïœçXÇ©Å@ñ≥éã
...
;<SoundVolume 0,0,1000>;mm BGMâπó ïœçXÇ©Å@ñ≥éã
...
[bgm storage="BGM04"]
;//ÅÙbgm04Å@îEÇ—äÒÇÈìIÅBèñèqÇ‚êSè€ÅB
...
;//èeê∫ÅEâìÇﬂ
;ïsóvÅH[wait_c time=1000]
[se buf=0 storage="seB063"]
;//ÅüÇrÇdÅ@îöî≠ÅiâìÇ≠Ç≈Åj
...
;<SoundFade 2,OUT,3000>
[bgm storage="BGM13"]
;//ÅÙbgm13Å@ì¶ëñÅBä≠êıÇPÇ≈Ç‡Ç®Ç»Ç∂Ç›
...
;ïsóvÅH[wait_c time=1000]
[bgm storage="seC019"];//SEÇÃChêîÇÃìsçáÇ≈BGMÇ…ÉGÉìÉWÉìâπÇ¢ÇÍÇ‹Ç∑
