...
;//ƒV[ƒ“–¼	Fwx
;//file–¼	F1140
;//“oêl•¨	FålŒöA@ˆê˜YAˆ©—œAÊŒA‰Ä“sAƒ^[ƒ„
;//•‘•		F§•
;//“ú•t		F8/19
;//ŠÔ		F()
;//”wŒi		F()
...
[bg storage="BG03b"][trans_c blind_lr time=1000]
...
[wait_c time=200]
[chara_int_top][trans_c wipe time=500]
...
*end02
;//•Ï” "g_1140" ‚ª¬—§‚Í ‰ÁZ‚µ‚È‚¢B
[if exp="sf.g_1140==1"][jump target=*NO_KASAN][endif]
;//ƒNƒŠƒA‰ñ”‰ÁZ
