...
;//*_‘I‘ğˆ
;//1,Š´õÒ‚Ìp‚ğ^—‚é @ƒ‰ƒxƒ‹fake@‚Ö
;//2,X‰ˆ‚¢‚É‰B‚ê‚Äi‚Ş   ƒ‰ƒxƒ‹hide@‚Ö

;	[link target=*fake]Š´õÒ‚Ìp‚ğ^—‚é[endlink]
;	[link target=*hide]X‰ˆ‚¢‚É‰B‚ê‚Äi‚Ş[endlink]
;[pcms]

*SEL10|Š´õÒ‚Ìp‚ğ^—‚é^X‰ˆ‚¢‚É‰B‚ê‚Äi‚Ş
[fc]
[pcms_sel]
...
[ChrSetEx layer=3 chbase="mob_kan2_x"][ChrSetXY layer=3 x=-90 y=0][trans_c cross time=150]
...
;//ƒ‰ƒCƒtƒ‹’P”­;//Ÿ‚r‚d@eº
[se buf=1 storage="seB067"]
;//’…’e‰¹B
[wait_c time=200]
[chara_int_ layer=2][trans_c tb time=300]
[quake_bg y m]
...
;//’…’e‰¹B
[wait_c time=200]
[chara_int_ layer=3][trans_c tb time=300]
[quake_bg y m]

[se buf=0 storage="seC046"]
;//ƒ‰ƒCƒtƒ‹’P”­;//Ÿ‚r‚d@eº
[se buf=1 storage="seB066"]
;//’…’e‰¹A
[wait_c time=200]
...
[se buf=0 storage="seC047" loop=true]
;//ƒ‰ƒCƒtƒ‹˜A”­

[se buf=1 storage="seB065" loop=true]
;//‰Î‰Š•úË
...
;//Ÿ‚ÌƒuƒƒbƒN1090‚Öjump
[jump storage="1090.ks" target=*1090_TOP]
