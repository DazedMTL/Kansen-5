...
;//ƒV[ƒ“–¼	FwĞ‰Ğ‚Ì‚½‚¾‚È‚©‚Öx
;//file–¼	F1010
;//“oêl•¨	FålŒöA@ˆê˜YAˆ©—œA‰Ä“sArˆä
;//•‘•		F§•
;//“ú•t		F8/19
;//ŠÔ		F()
;//”wŒi		Fƒzƒeƒ‹˜L‰º¨‹qº¨˜L‰º¨ƒƒr[¨ƒGƒ“ƒgƒ‰ƒ“ƒX
;//—\‘z—e—Ê	F‘S‘Ì‚ğ’Ê‚µ‚Ä10~14K‘OŒã
;//”õl		FålŒöˆêlÌ‹“_
;//QQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
*1010_TOP
;{SceneSet Ğ‰Ğ‚Ì‚½‚¾‚È‚©‚Ö}
...
;//Ÿ‘Oƒtƒ@ƒCƒ‹‚ÅAˆ©—œ‚ÍŒx@‚É“d˜b‚µ‚Ä‚¢‚Ü‚·‚Ì‚ÅŒg‘ÑŠ‚Æ‚µ‚Ä‚¨‚«‚Ü‚·
...
;//*_‘I‘ğˆ
;//1,ƒGƒŒƒx[ƒ^[‚ğg‚¤   ƒ‰ƒxƒ‹elevator‚Ö
;//2,ŠK’i‚ğg‚¤   @@@@ƒ‰ƒxƒ‹kaidan‚Ö

;	[link target=*elevator]ƒGƒŒƒx[ƒ^[‚ğg‚¤[endlink]
;	[link target=*kaidan]ŠK’i‚ğg‚¤[endlink]
;[pcms]

*SEL07|ƒGƒŒƒx[ƒ^[‚ğg‚¤^ŠK’i‚ğg‚¤
[fc]
[pcms_sel]
...
;//m:“]‚ñ‚Å‚é‚ç‚µ‚¢‚Ì‚Å‰º‚°‚Ä‚¨‚­B–Ê”’‚·‚¬‚é‚æ‚¤‚È‚çC³
...
;//*_‘I‘ğˆ
;//1,ˆê‚ÉˆÚ“®‚µ‚æ‚¤   ƒ‰ƒxƒ‹together‚Ö
;//2,“ñè‚É•ª‚©‚ê‚æ‚¤   ƒ‰ƒxƒ‹futate‚Ö
;//3,æ‚è‚ ‚¦‚¸‰Ä“s‚ğŒÄ‚Ô   ƒ‰ƒxƒ‹call_natu‚Ö

;	[link target=*together]ˆê‚ÉˆÚ“®‚µ‚æ‚¤[endlink]
;	[link target=*futate]“ñè‚É•ª‚©‚ê‚æ‚¤[endlink]
;	[link target=*call_natu]æ‚è‚ ‚¦‚¸o‚¿‚á‚ñ‚ğŒÄ‚Ô[endlink]
;[pcms]

*SEL08|ˆê‚ÉˆÚ“®‚µ‚æ‚¤^“ñè‚É•ª‚©‚ê‚æ‚¤^æ‚è‚ ‚¦‚¸o‚¿‚á‚ñ‚ğŒÄ‚Ô
[fc]
[pcms_sel]
...
;//Ÿ‚r‚d@•s³ˆ—‰¹iƒsƒsƒsƒsƒsƒsƒsƒsƒsƒsƒbj
...
;//rˆä‰E—ƒWƒƒ[ƒW‚Piã’…‚È‚µj@•\î06@”ßˆ£;//
