...
;//ƒV[ƒ“–¼	Fw‹C‚Ü‚¸‚¢”Ó`x
;//file–¼	F0390
;//“oêl•¨	FålŒöA@ˆê˜YAˆ©—œAÊŒA”ü¹A‰Ò’Ã‰›AƒIƒY
;//•‘•		F§•
;//“ú•t		F8/18
;//ŠÔ		F(18)
;//”wŒi		F‰z’q–{‰Æ˜aº(—[•û)
;//—\‘z—e—Ê	F‘S‘Ì‚ğ’Ê‚µ‚Ä12~15K‘OŒã
;//”õl		FålŒöˆêlÌ‹“_
;//QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
*0390_TOP
;{SceneSet ‹C‚Ü‚¸‚¢”Ó`}
...
;//ŸŒÄÌ•\‚Å‚Í‘O“c‚³‚ñ‚Å‚·‚ªA‰Ò’Ã‰›‚à‘O“c‚³‚ñ‚È‚Ì‚ÅA‚±‚Ìƒtƒ@ƒCƒ‹‚Å‚Í—¼–¼‚ğ–¼‘O‚ÅŒÄ‚ñ‚Å‚¢‚Ü‚·
...
;//ŸŒÄÌ•\‚Å‚·‚ÆŒºŸ˜Y‚ª–lA‰Ò’Ã‰›‚ª„‚É‚È‚Á‚Ä‚¢‚Ü‚·‚ªA‹tH
;//Ÿ‚Æ‚è‚ ‚¦‚¸Aƒvƒƒbƒg’Ê‚è‰Ò’Ã‰›‚ğ–l‚Æ‚µ‚Ä‚¨‚«‚Ü‚·
...
;//m:’†–ìƒuƒ[ƒhƒXƒgƒŠ[ƒg‚©’†–ìƒuƒ[ƒhƒEƒFƒC‚Ì‚Ç‚¿‚ç‚©‚ğg—pBÊŒ‚ÌƒZƒŠƒt‚Æ‡‚í‚¹
...
;//m:ƒgƒDƒ‹[ƒ‹[ƒg‚É“ü‚ê‚éê‡‚ÍZAP‚ğŒ©‚ê‚È‚¢
;[if exp="f.l_goto_ƒgƒDƒ‹[==1"][jump target=*nozap][endif]
;*hanazawa_zap
;<ZapDel>
;<ZapAdd 0,4,ON,0410.txt,0410_TOP>
;<ZapRun>
;*nozap
;//---------------------------------------------
...
;//ŸŒ —˜NŠQ‚Ì‰ñ”ğ‚ğ‚µ‚Ä‚¢‚Ü‚·
;//Ÿ‘—§Š´õÇŒ¤‹†Š‚Æ‚©‚È‚ç‰ñ”ğ‚µ‚È‚­‚Ä‚à‚¢‚¢‚Ì‚©‚à
;//Ÿa’J—X•Ö‹Ç‚Æ‚©‰ñ”ğ‚µ‚Ä‚¢‚é‚æ‚¤‚È‚à‚Ì‚Å‚·‚æ‚Ë
;//ŸÀİ‚Ì–¼‘O‚ğg‚¦‚é‚È‚çA‚»‚Á‚¿‚Ì•û‚ªŠiD‚¢‚¢‚Å‚·‚Ì‚Å
...
;//m:Š´õÒ‚Æ‚©ƒtƒ‰ƒbƒVƒ…ƒoƒbƒN
;//#_”’ƒtƒ‰
[evcg”’ƒtƒ‰ storage="mob_N014b" layer=6 left=-900 top=0]
...
*ZAP04|ƒUƒbƒsƒ“ƒO‘I‘ğˆ@‚»‚Ì‘¼^ƒLƒƒƒ“ƒZƒ‹
...
[jump storage="0410.ks" target=*0410_TOP]
