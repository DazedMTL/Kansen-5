...
[bg storage="village05b"][trans_c blind_lr time=1000]
[bgm storage="BGM18"]
;//ôbgm18@ì’†Œ€—p/ˆÀ“g
...
;//‚ß‚àFBGM‚ÍålŒö‚ÌŠ¨ˆá‚¢‚à‚ ‚é‚Ì‚Å‚±‚êg‚¢‚Ü‚·
[bgm storage="BGM16"]
;//ôbgm16@ƒGƒƒV[ƒ“F“¦‘–
...
*end02
;//•Ï” "g_2440" ‚ª¬—§‚Í ‰ÁZ‚µ‚È‚¢B
[if exp="sf.g_2440==1"][jump target=*NO_KASAN][endif]
;//ƒNƒŠƒA‰ñ”‰ÁZ
